...
public class VendingMachineTest {
    ...
    public void test_VendingMachine_05() {
        ...
        vm.add("Doritos Nacho Cheese", 1);
        assertEquals("Doritos Nacho Cheese (1)", vm.checkStock("Doritos Nacho Cheese"));
        assertEquals("Stock: Cheetos Crunchy (0), Coke (0), Doritos Nacho Cheese (1), Red Bull (0)", vm.checkStock());

        vm.dispense("Doritos Nacho Cheese", 2);
        assertEquals("Doritos Nacho Cheese (-1)", vm.checkStock("Doritos Nacho Cheese"));
        assertEquals("Stock: Cheetos Crunchy (0), Coke (0), Doritos Nacho Cheese (-1), Red Bull (0)", vm.checkStock());

        vm.add("Doritos Nacho Cheese", 1);
        assertEquals("Doritos Nacho Cheese (0)", vm.checkStock("Doritos Nacho Cheese"));
        assertEquals("Stock: Cheetos Crunchy (0), Coke (0), Doritos Nacho Cheese (0), Red Bull (0)", vm.checkStock());
    }
